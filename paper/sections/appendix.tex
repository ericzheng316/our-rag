...
tokens). Remaining infrastructure and guard criteria: TODO.
% 原附录 C 材料待填。
...
\label{app:seeds}
TODO.
% 同种子复跑批(run7 / 0816 / 0817 = 48.20 / 48.53 / 45.68, 47.5±1.6; ABLATION_TABLES §1b)。

\section{Extended training}
\label{app:extended}
TODO.
% ep100→120→140→160→180 = 48.20 / 50.27 / 47.58 / 48.70 / 48.53; ep120 vs ep100 z=2.99 (4-hop z=3.61); 退化观测 (ABLATION_TABLES §1c)。

\section{Verifier validation}
\label{app:verifier}
TODO.
% 4B judge 组件验收 (AUC 0.9961 / 2Wiki 0.9865 / ECE 0.0132; 系统级 0.742; HANDOFF §6)。
