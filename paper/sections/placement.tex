...
questions---is 82\% correct. An audit cannot raise accuracy, but it
concentrates it: the signal identifies which answers to trust and
which questions need a different tool.
