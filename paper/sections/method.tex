...
action distribution at $s_t$: the counterfactual baseline of
\citet{foerster2018coma} applied to the query action, with samples drawn
from the visited state as in the vine estimator of
