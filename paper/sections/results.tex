...
Table~\ref{tab:main-qc} compares the three arms of seed 1 at step 100
on the closed-pool MuSiQue development set. Query-level credit reaches
...
wiki18 MuSiQue, continued training against the open retriever reaches
28.67 EM against 22.09 for ReSearch, the strongest external system
(paired $z=7.98$); on HotpotQA, 48.55 against 45.00 for Search-R1
($z=3.94$); on the 139k corpus, the extended-training checkpoint
reaches 45.64 against 32.77.
...
\midrule
Ours, query-level credit, + 50 episodes against wiki18   & 28.55 & 38.81 & \textbf{48.55} & 44.45 & 44.97 \\
\rowcolor{gray!20}
Ours, outcome-only, + 50 episodes with credit against wiki18 & \textbf{28.67} & \textbf{39.67} & 47.80 & \textbf{47.00} & 43.98 \\
...
% MuSiQue vs.\ ReSearch $z=7.98$ (shaded row) / $7.80$; HotpotQA vs.\
% Search-R1 $z=3.18$ / $3.94$. 2Wiki: external systems not yet run (6 evals);
