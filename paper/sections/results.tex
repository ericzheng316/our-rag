...
Table~\ref{tab:external} places the trained policies against six
search-RL systems---R3-RAG~\citep{li2025r3},
...
ReSearch~\citep{chen2025research}---reproduced under one retrieval
environment; the two rows of ours are the query-level arm after 50
episodes against wiki18 (\S\ref{sec:results-stage2}) and the
extended-training checkpoint of Appendix~E. On
...
\midrule
R3-RAG       & ---   & ---   & 38.20 & --- & 16.34 \\
ZeroSearch   & 9.43  & 16.78 & 30.70 & --- & 11.92 \\
R1-Searcher  & 15.27 & 22.88 & 39.60 & --- & 24.74 \\
StepSearch   & 18.25 & 26.96 & 35.15 & --- & 25.49 \\
Search-R1    & 20.40 & 29.50 & 45.00 & --- & 31.73 \\
ReSearch     & 22.09 & 32.43 & 44.05 & --- & 32.77 \\
\midrule
\rowcolor{shade}
Ours (+50 ep.\ on wiki18) & \textbf{28.55} & \textbf{38.81} & \textbf{48.55} & \textbf{44.45} & 44.97 \\
Ours (extended, App.~E)    & 26.52 & 36.90 & 47.15 & 41.75 & \textbf{45.64} \\
\bottomrule
\end{tabular}
...
% R3-RAG (R3-RAG-Qwen, Qwen2.5-7B): free-form answers scored as processed EM
% (short answer extracted by Qwen2.5-72B for HotpotQA, Qwen3.5-122B for the
% 139k run; UNANSWERABLE 23.0\% on 139k); HotpotQA 2k-subset value taken from
% the full-dev (7,405) run by question match; paired vs ours: 139k ep120
% 773:68 $z=24.3$, HotpotQA q2q1 324:117 $z=9.86$. R3-RAG on wiki18 MuSiQue /
% 2Wiki: not yet run (r3_wiki18 suite started 2026-09-18, experiment window).
% 2Wiki: external systems not yet run (6 evals);
