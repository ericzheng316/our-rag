...
def load_retriever():
    ...
    if dense_retriever is None:
        ...
        retrieval_config = {
                ...
                'index_path': "/inspire/hdd/ws-8207e9e2-e733-4eec-a475-cfa1c36480ba/embodied-multimodality/public/yli/workspace/Datasets/Tevatron/wikipedia-nq-corpus-flashragformat/index_bm25/bm25",
