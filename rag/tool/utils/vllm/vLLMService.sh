...
# CUDA_VISIBLE_DEVICES=4,5 vllm serve /inspire/hdd/ws-8207e9e2-e733-4eec-a475-cfa1c36480ba/embodied-multimodality/public/yli/workspace/Model/Qwen/Qwen2.5-14B-Instruct  \
...
CUDA_VISIBLE_DEVICES=$CUDA_VISIBLE_DEVICES vllm serve /inspire/hdd/ws-8207e9e2-e733-4eec-a475-cfa1c36480ba/embodied-multimodality/public/yli/workspace/Model/Qwen/Qwen2.5-14B-Instruct  \
    ...
    # --dtype half \
    # 
# "/remote-home1/yli/Model/Generator/Qwen2.5/72B"
# /remote-home1/yli/Model/Generator/Qwen2.5/7B/instruct 
# $tensor_parallel_size
# /remote-home1/share/models/Qwen2.5-32B-Instruct
# /remote-home1/share/models/Qwen2.5-32B-Instruct