...
def task_to_execute():
    ...
    logger.info("执行任务...")
    # 你的代码...
    query_list = ["What is the capital of France?", "What is the largest mammal?", "How does photosynthesis work?", "Explain quantum entanglement.", "What is the theory of relativity?", "Describe the process of cellular respiration.", "What are black holes?", "Explain the concept of time dilation.", "What is the Big Bang theory?", "How do vaccines work?"]
    query_list = query_list*1024
    doc_list = GetRetrieval("http://10.244.151.169:8001/search", query_list)
