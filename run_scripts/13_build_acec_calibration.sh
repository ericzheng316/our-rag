...
# Run after 12_run_acec_distractor_pilot.sh has produced a fresh records.jsonl
# with 'supporting_facts'. Pure CPU/light-GPU replay of already-logged
# trajectories — no new LLM inference.
#
# 用法:
#   NLI_MODEL=cross-encoder/nli-deberta-v3-base bash 13_build_acec_calibration.sh
...
$HOME/rag/.venv/bin/python $HOME/rag/run_scripts/build_acec_calibration.py \
    --records ${RECORDS} \
